...
N 190 80 190 100 {
lab=GND}
C {OpenLane/pdks/sky130A/libs.tech/xschem/sky130_fd_pr/nfet_01v8.sym} 10 0 0 0 {name=M1
W=1
L=0.15
nf=1 
mult=1
...
C {lab_pin.sym} 30 -150 0 0 {name=p3 sig_type=std_logic lab=VCC
}
...
C {lab_pin.sym} 190 -40 0 0 {name=p1 sig_type=std_logic lab=VOUT}
